<template xmlns:v-on="http://www.w3.org/1999/xhtml">
  <div class="div1">
    <div style="height: 10px;background: #EBEDF0;"></div>
    <el-amap :vid="'amap-vue'" :center="center" :zoom="zoom" :map-manager="amapManager" :plugin="plugin" :events="events" style="height: 400px;width: 100%;">
